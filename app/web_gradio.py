...
def make_sidebar_context_card(page):
    context = {
        "dashboard": {
            ...
            "body": "Halaman ini memperkenalkan fungsi utama Helmet Vision, alur kerja sistem, dan mode deteksi yang tersedia.",
        },
        "realtime": {
    ...
    with gr.Row(elem_classes="top-nav"):
        with gr.Column(scale=1, min_width=220):
            ...
            <div class="logo-wrap">
                ...
                <div class="logo-text">Helmet Vision</div>
            </div>
            """)
